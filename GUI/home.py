...
class HomeFrame(tk.Frame):
	def __init__(self, parent, controller):
		...
		self.searchPassBtn = tk.Button(self.homeFrame, text = "Retrieve Password", bg=self.primaryColor, fg=self.secTextColor, command=lambda:[controller.show_frame(SearchPassFrame)], font = self.labelFont)
